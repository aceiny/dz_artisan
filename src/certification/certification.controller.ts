...
export class CertificationController {
  ...
  @ApiOperation({
    ...
    description:
      'This will return a certification by ID for the logged in user',
    responses: {
      200: {
  ...
  @ApiOperation({
    ...
    description:
      'This will update a certification by ID for the logged in user',
    responses: {
      200: {
  ...
  @ApiOperation({
    ...
    description:
      'This will delete a certification by ID for the logged in user',
    responses: {
      200: {
