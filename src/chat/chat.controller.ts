...
export class ChatController {
    ...
    @ApiOperation({
        ...
        description: 'This endpoint is used to acess or create a chat between two users. If the chat already exists, it will return the chat, otherwise it will create a new chat and return it.',
    })
    @Post('')
    ...
    async acessOrCreateChat(
        ...
        const data = await this.chatService.acessOrCreateChat(createChatDto , user.id);
        return {
